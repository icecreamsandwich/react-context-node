    ...
    return (
      <div>
        <React.Fragment>
          ...
          and {context_ar.state.name} is{' '}
          <strong>
            {' '}
            {context_ar.state.cool ? hot_cool_ar[1] : hot_cool_ar[0]}
          </strong>{' '}
          <br />
        </React.Fragment>
        <button onClick={context_ar.makeitHot}>
          Make it {context_ar.state.cool ? hot_cool_ar[0] : hot_cool_ar[1]}
        </button>{' '}
        <br /> <br />
